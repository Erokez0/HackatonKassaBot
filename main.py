...
@bot.message_handler(commands=['qr_reg'], chat_types=['group', 'supergeoup'])
...
@bot.message_handler(commands=['start', 'help'], chat_types=['group', 'supergeoup'])
...
@bot.message_handler(commands=['get_status'], chat_types=['group', 'supergeoup'])
...
@bot.message_handler(content_types=['text', 'help'], chat_types=['group', 'supergeoup'])
